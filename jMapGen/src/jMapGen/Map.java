...
//	}
	...
	{
		Vector<Point> newCorners = new Vector<Point>(corners.length);
		
		Corner q, Center r, Point point, int i, Edge edge;
	...
	public Corner[] landCorners(Vector<Corner> corners) {
		Corner q; 
	...
	return (Corner[])locations.toArray();
	}
	...
	public void buildGraph(Vector<Point> points, Voronoi voronoi) {
		Center p; Corner q; Point point; Point other;
